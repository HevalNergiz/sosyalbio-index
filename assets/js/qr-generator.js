  ...
  // Change the URL in lines 6 and 10 for the "Learn More" button in the homepage hero
        ...
        $(function() {
            ...
            function generateQRcode(width, height, url) {
               ...
               /* var qrdiv = document.getElementById('qrdivi1');
                qrdiv.classList.add("qr-icin-neumorphism");*/
        ...
        $(function() {
            ...
            function generateQRcode(width, height, text, msg) {
                ...
                /*var qrdiv5 = document.getElementById('#sms-qrcode');
                qrdiv5.classList.add("qr-icin-neumorphism");*/
                var btn = document.getElementById('downloadsvg');
                btn.style.display = "block";
                $('canvas').removeAttr('id')
        ...
        $(function() {
            ...
            function generateQRcode(width, height, email) {
              ...
              /*  var qrdiv2 = document.getElementById('qrdivi2');
                qrdiv2.classList.add("qr-icin-neumorphism");*/
                var btn = document.getElementById('downloadsvg');
                btn.style.display = "block";
                $('canvas').removeAttr('id')
        ...
        $(function() {
            ...
            function generateQRcode(width, height, tel) {
               ...
               /* var qrdiv3 = document.getElementById('qrdivi3');
                qrdiv3.classList.add("qr-icin-neumorphism");*/
                var btn = document.getElementById('downloadsvg');
                btn.style.display = "block";
                $('canvas').removeAttr('id')
        ...
        $(function() {
            ...
            function generateQRcode(width, height, yutube) {
               ...
               /* var qrdiv4 = document.getElementById('qrdivi4');
                qrdiv4.classList.add("qr-icin-neumorphism");*/
                var btn = document.getElementById('downloadsvg');
                btn.style.display = "block";
                $('canvas').removeAttr('id')
